...
class InputWordDialog(val hint: String, context: Context, themeResId: Int, private val listener: OnClickListener) :
        Dialog(context, themeResId) {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.input_word_dialog)
        initView()
    }

    private fun initView() {
        if (hint != "") {
            findViewById<EditText>(R.id.etDialogContent).hint = hint
        }
