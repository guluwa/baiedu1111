...
class TeacherHomeWorkActivity : BaseActivity() {
    ...
    override val viewLayoutId: Int get() = R.layout.activity_class_home_work
    ...
    private fun initToolBar() {
        tvToolBarTitle.text = getString(R.string.menu_my_work)
    ...
    private fun initRecyclerView() {
        ...
        mRecyclerView.adapter = ClassListAdapter(arrayListOf(PageTipBean("", 0, 1)), object : OnClickListener {
            override fun click(arg1: Int, arg2: Any) {
                ...
                val intent = Intent(this@TeacherHomeWorkActivity, ClassHomeWorksActivity::class.java)
