...
class BotVoiceSelectDialog(context: Context, themeResId: Int, private val listener: OnClickListener) :
    Dialog(context, themeResId) {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.bot_voice_select_dialog)
        initView()
    }
    ...
    private fun initView() {
        ...
        findViewById<TextView>(R.id.tvPlay).setOnClickListener {
            listener.click(1,"")
            dismiss()
        }
